...
map.getView().fit([-14837797.309942, 1041731.734206, -6033199.395869, 10163172.776412], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Территория проживания</h2>';
        return titleElement;
    })(),
